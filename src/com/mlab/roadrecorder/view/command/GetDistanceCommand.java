...
public class GetDistanceCommand extends GetValueCommand {

	public GetDistanceCommand(GpsModel model) {
		super(model);
	}

	@Override
	public String getValue() {
		String value = String.format("%8.1f", ((GpsModel)model).getDistance());
		return value;
	}
